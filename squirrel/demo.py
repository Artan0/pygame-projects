...
def runGame():
    ...
    while True: # main game loop
        ...
        if (camerax + HALF_WINWIDTH) - playerCenterx > CAMERASLACK_H:
            camerax = playerCenterx + CAMERASLACK_H - HALF_WINWIDTH
        elif playerCenterx - (camerax + HALF_WINWIDTH) > CAMERASLACK_H:
            camerax = playerCenterx - CAMERASLACK_H - HALF_WINWIDTH
        if (cameray + HALF_WINHEIGHT) - playerCentery > CAMERASLACK_V:
            cameray = playerCentery + CAMERASLACK_V - HALF_WINHEIGHT
        elif playerCentery - (cameray + HALF_WINHEIGHT) > CAMERASLACK_V:
            cameray = playerCentery - CAMERASLACK_V - HALF_WINHEIGHT
