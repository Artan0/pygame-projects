...
def main():
    ...
    while True: # main game loop
        ...
        if result in ('solved', 'next'):
            ...
            #Task 2
            previousLevel = currentLevelIndex
            while currentLevelIndex == previousLevel:
                currentLevelIndex = random.randint(0, len(levels) - 1)
            ...
            #Task 2
            currentLevelIndex = previousLevel
...
def makeMove(mapObj, gameStateObj, playerMoveTo):
    ...
    if isWall(mapObj, playerx + xOffset, playery + yOffset):
        ...
        # Check for consecutive stars in the direction of movement.
        while (playerx + xOffset, playery + yOffset) in stars:
            # Check if the next position is valid for pushing.
